...
const PostCard = ({ post }) => {
  ...
  return (
    ...
    rounded-lg p-0 lg:p-8 pb-12 mb-8">
      ...
      <h1 className="transition duration-700 text-center mb-8 px-4
      ...
      <p className="text-center text-sm text-gray-700
        font-normal  sm:text-sm lg:text-base px-4 lg:px-20 mb-8">{post.excerpt}</p>
      <div className="text-center">
        <Link href={`/post/${post.slug}`}>
          <span className="transition duration-500 transform
             hover:-translate-y-1 inline-block bg-pink-600
              text-lg font-medium rounded-full text-white
